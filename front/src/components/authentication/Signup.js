...
const Signup = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("cloud_name", "dzdqr4hw8");
      fetch("https://api.cloudinary.com/v1_1/dzdqr4hw8/image/upload", {
        method: "post",
        body: data,
      })
        .then((res) => res.json())
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      // toast({
      //   title: "An Email sent to your registered account. Please Verify!",
      //   status: "success",
      //   duration: 5000,
      //   isClosable: true,
      //   position: "bottom",
